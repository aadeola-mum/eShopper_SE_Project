...
import cs425.team4.eshopper.exceptions.FileNotFoundException;
import cs425.team4.eshopper.exceptions.FileStorageException;
import cs425.team4.eshopper.property.FileStorageProperties;
...
//    public String storeFile(MultipartFile file, long productId) throws FileStorageException {
//        // Normalize file name
...
//            String newName = "PRD_IMG_"+productId+"_"+ System.currentTimeMillis()+"."+extension;
